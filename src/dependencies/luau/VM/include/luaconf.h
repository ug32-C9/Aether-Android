...
namespace roblox::addresses {
    ...
    // luaD_* functions
    constexpr std::uintptr_t luaD_throw = 0x36D245C; // lua_error <- luaL_error
    constexpr std::uintptr_t luaD_rawrunprotected = 0x36D2400; // luaD_pcall
    
    // luaC_* functions
    constexpr std::uintptr_t luaC_step = 0x36D3168; // lua_newthread
    constexpr std::uintptr_t luaC_barriertable = 0x36D3C44;
    ...
    constexpr std::uintptr_t dummynode = 0xD141D8; // luaH_getnum
}